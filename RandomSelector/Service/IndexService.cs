...
namespace RandomSelector.Service
{
    ...
    public class IndexService
    {
        ...
        public IndexViewModel CreateViewModel()
        {
            ...
            // 初期選択からは「基本」「陰謀2nd」「Reneissance」「プロモ」を外しておく
            var exclusionExpansion = new[] { ExpansionID.Basic, ExpansionID.Promotion, ExpansionID.Intrigue2nd, ExpansionID.Renaissance };
